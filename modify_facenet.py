...
#     LayerNormalization, Permute, add
# )
...
# weights_h5 = "models/facenet_keras_weights.h5"
...
# model.save("facenet")
# model.export("models/facenet_saved_model")
...
# tf.config.set_visible_devices([], 'GPU')
model = load_model("facenet.keras", custom_objects={"scaling": scaling})
spec = (tf.TensorSpec((1, 3, 160, 160), tf.float32, name="input_1"),)
model_proto, _ = tf2onnx.convert.from_keras(model, input_signature=spec, opset=13)
with open("models/facenet.onnx", "wb") as f:
    f.write(model_proto.SerializeToString())

quit()

# Convert to ONNX
spec = (tf.TensorSpec((None, 3, 160, 160), tf.float32, name="input_1"),)
output_path = "facenet.onnx"
